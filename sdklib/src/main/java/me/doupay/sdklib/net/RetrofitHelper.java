...
import me.doupay.sdklib.BuildConfig;
import me.doupay.sdklib.Constants;
import me.doupay.sdklib.net.interceptors.DefaultLoggingInterceptor;
import me.doupay.sdklib.net.interceptors.Level;
import me.doupay.sdklib.net.interceptors.LoggingInterceptor;
...
public class RetrofitHelper {
    ...
    public Retrofit getINSTANCE(boolean addSSL) {
        OkHttpClient client = OkhttpHelper.getDefaultClient(addSSL, new LoggingInterceptor.Builder().loggable(BuildConfig.DEBUG)
